# HR SYSTEM — HRCore (Restaurant Operations)

სტატიკური ვებაპი Supabase-თან (`restaurant-hr/index.html`).
...
იხილეთ `restaurant-hr/SUPABASE_SETUP_KA.md` და `restaurant-hr/supabase-setup-from-zero.sql`.
