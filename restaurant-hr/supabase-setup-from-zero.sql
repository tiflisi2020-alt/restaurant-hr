...
-- საცნობი ცხრილები: ნაგულისხმევად RLS არა; PIN/anon აპისთვის ქვემოთ ემატება hrcore_anon_pin
-- (თუ მოგვიანებით მხოლოდ Dashboard-ში ჩართავთ RLS, anon პოლიტიკა INSERT-ს გაუშვებს).

-- -----------------------------------------------------------------------------
-- PIN / ლოკალური კოდი (Supabase email login გარეშე): anon JWT + ეს პოლიტიკები
-- -----------------------------------------------------------------------------
